...
contract GameNFT is ERC721Enumerable, Ownable {
    ...
    //  _price is the price of one GameNFT
    uint256 public _price = 0.1 ether;

    // _paused is used to pause the contract in case of an emergency
    bool public _paused;

    // max number of GameNFT
     ...
     * name in our case is `GameNFT` and symbol is `GNFT`.
     * Constructor for GNFT takes in the baseURI to set _baseTokenURI for the collection.
     */
    ...
    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < maxTokenIds, "Exceed maximum GameNFT supply");
